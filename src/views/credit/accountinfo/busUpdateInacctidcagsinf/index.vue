  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','busUpdateInacctidcagsinf:edit','busUpdateInacctidcagsinf:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudBusUpdateInacctidcagsinf from '@/api/acc/busUpdateInacctidcagsinf'
...
const defaultForm = { id: null, accloanid: null, infrectype: null, odbnescode: null, nwbnescode: null, uploadstatus: null, uploadflag: null, createTime: null }
export default {
  name: 'BusUpdateInacctidcagsinf',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  dicts: ['acc_InfRecType'],
  cruds() {
    return CRUD({ title: '/api/update_inacctidcagsinf', url: 'api/busUpdateInacctidcagsinf', sort: 'id,desc', crudMethod: { ...crudBusUpdateInacctidcagsinf }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'busUpdateInacctidcagsinf:add'],
        edit: ['admin', 'busUpdateInacctidcagsinf:edit'],
        del: ['admin', 'busUpdateInacctidcagsinf:del']
      },
      rules: {
      },
      queryTypeOptions: [
