  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','busDelInacctentdel:edit','busDelInacctentdel:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudBusDelInacctentdel from '@/api/acc/busDelInacctentdel'
...
const defaultForm = { id: null, accloanid: null, infrectype: null, delreccode: null, uploadstatus: null, uploadflag: null, createTime: null }
export default {
  name: 'BusDelInacctentdel',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '/api/del_inacctentdel', url: 'api/busDelInacctentdel', sort: 'id,desc', crudMethod: { ...crudBusDelInacctentdel }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'busDelInacctentdel:add'],
        edit: ['admin', 'busDelInacctentdel:edit'],
        del: ['admin', 'busDelInacctentdel:del']
      },
      rules: {
        id: [
