  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','busDelCustomerInfo:edit','busDelCustomerInfo:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
export default {
  ...
  data() {
    return {
      permission: {
        add: ['admin', 'busDelCustomerInfo:add'],
        edit: ['admin', 'busDelCustomerInfo:edit'],
        del: ['admin', 'busDelCustomerInfo:del']
      },
      rules: {
        id: [
